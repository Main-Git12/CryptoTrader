...
This tracks social mention volume and sentiment for crypto tickers. It is
**informational only** — no trade execution, no explicit buy/sell
recommendations, no portfolio management. Don't add features that cross
that line without the user explicitly asking for it; if a request implies
crossing it, flag the implication before building.
